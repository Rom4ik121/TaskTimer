...
- BottomSheet: секции Статус, Приоритет, Сортировка, Теги; «Сбросить» + «Готово»
- Фокус: фильтр истории «Все / С заметкой» тоже в листе (пресеты 15/5 остаются). Дом-чипы Wave AT не трогали; Поиск/Статы/Холст без полос фильтров
