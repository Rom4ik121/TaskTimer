...
Кратко по волнам **A–AC** (схема SQLite → `SCHEMA_VERSION = 11`, без бампа в Z/AA/AB/AC). Wave **T** — импульс и застой; **U** — итог дня; **V** — умный совет; **W** — пресеты фокуса и badge; **X** — inbox / заметка / undo / CSV / compact; **Y** — недавний поиск; **Z** — About.
